...
// 1. Agent Executor
writeFile('src/lib/ai/agent-executor.ts', `import { SupabaseClient } from '@supabase/supabase-js';
...
// 2. Run route
writeFile('src/app/api/cards/[id]/agent-tasks/[taskId]/run/route.ts', `import { NextRequest } from 'next/server';
