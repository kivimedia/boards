...
const PHASE_NAMES: string[] = [
  ...
  'Image Optimization',
  'Desktop VQA Capture',
  'Desktop VQA Comparison',
  'Desktop VQA Fix Loop',
  'Desktop Functional QA',
  'Mobile Markup Generation',
  'Mobile Deploy',
  'Mobile VQA Capture',
  'Mobile VQA Comparison',
  'Mobile VQA Fix Loop',
...
const PHASE_KEYS = [
  ...
  'markup_generation', 'markup_validation', 'deploy_draft', 'draft_review_gate',
  'image_optimization',
  'vqa_capture', 'vqa_comparison', 'vqa_fix_loop', 'functional_qa',
  'mobile_markup_generation', 'mobile_deploy',
  'mobile_vqa_capture', 'mobile_vqa_comparison', 'mobile_vqa_fix_loop', 'mobile_functional_qa',
  'animation_detection', 'animation_implementation',
  'seo_config', 'report_generation', 'final_review_gate', 'am_signoff_gate',
];

const GATE_STATUSES: PageForgeBuildStatus[] = [
  'element_mapping_gate' as PageForgeBuildStatus,
  'draft_review_gate',
  'final_review_gate' as PageForgeBuildStatus,
  'am_signoff_gate',
];
...
const IN_PROGRESS_STATUSES: PageForgeBuildStatus[] = [
  ...
  'vqa_fix_loop',
  'functional_qa',
  'mobile_markup_generation' as PageForgeBuildStatus,
  'mobile_deploy' as PageForgeBuildStatus,
  'mobile_vqa_capture' as PageForgeBuildStatus,
  'mobile_vqa_comparison' as PageForgeBuildStatus,
  'mobile_vqa_fix_loop' as PageForgeBuildStatus,
  'mobile_functional_qa' as PageForgeBuildStatus,
  'animation_detection' as PageForgeBuildStatus,
  'animation_implementation' as PageForgeBuildStatus,
  'seo_config',
  'report_generation',
  'final_review_gate' as PageForgeBuildStatus,
  'am_signoff_gate',
