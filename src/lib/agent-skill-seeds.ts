...
export const SKILL_SEEDS: SkillSeed[] = [
  ...
  },
  {
    ...
    estimated_tokens: 3000,
    depends_on: ['historian-orchestrator'],
  ...
  },
  {
    ...
    strengths: [
      ...
      'Supports Humanity API integration for event attribution (Stages Plus)',
    ],
    weaknesses: [
    ...
    estimated_tokens: 4000,
    depends_on: ['historian-collector'],
    feeds_into: ['historian-sidekick'],
    requires_mcp_tools: [],
    fallback_behavior: 'If vision model unavailable, generate metadata from filename and Slack context only.',
    reference_docs: [],
    icon: '🔍',
    color: '#059669',
    sort_order: 32,
