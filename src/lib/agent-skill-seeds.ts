...
export const SKILL_SEEDS: SkillSeed[] = [
  ...
  // =========================================================================
  {
    ...
    description: 'Google Ads account management agent. Monitors campaigns, keywords, and search terms. Identifies wasted spend and paid-to-organic transition opportunities.',
    category: 'seo',
    pack: 'seo_team',
    quality_tier: 'solid',
    quality_score: 72,
    quality_notes: 'New agent. Solid tool integration design with proper confirmation gates on write operations. Needs real-world calibration on recommendation accuracy.',
    strengths: [
      'Direct access to search terms report - the bridge between paid and organic',
      'Budget optimization with safety checks (120% threshold alerts)',
      'Paid-to-organic transition analysis with organic position verification',
      'Quality score improvement tied to content quality recommendations',
    ],
    weaknesses: [
      'No historical trend analysis yet - only point-in-time snapshots',
      'Cannot yet cross-reference with Search Console data automatically',
      'Recommendation confidence levels need calibration from real usage',
    ],
    improvement_suggestions: [
      'Add time-series budget tracking for trend detection',
      'Integrate Search Console position data for automated transition scoring',
      'Add competitor bid landscape awareness',
    ],
    ...
    fallback_behavior: 'Use cached data from google_ads_cache if API unavailable. If no cache, report the issue and suggest credential setup.',
    reference_docs: [],
    is_team_member: true,
    icon: '💰',
    color: '#F59E0B',
  ...
  },
  {
    ...
    description: 'Competitive intelligence agent. Pulls and analyzes competitor ad creatives, messaging strategies, and regional targeting from Google Ads Transparency Library.',
    category: 'seo',
    pack: 'seo_team',
    quality_tier: 'solid',
    quality_score: 70,
    quality_notes: 'New agent. Good framework for competitive analysis. Image/video analysis via external AI adds unique value. Needs real data to validate messaging gap detection accuracy.',
    strengths: [
      'Messaging gap analysis - identifies what competitors are NOT saying',
      'Regional targeting visibility for local SEO strategies',
      'AI-powered creative analysis (images + videos)',
      'Structured output feeds directly into content briefs',
    ],
    weaknesses: [
      'Dependent on Google Ads Transparency Library availability',
      'Cannot estimate actual competitor spend - only impression ranges',
      'Video analysis requires Gemini API key (optional dependency)',
    ],
    improvement_suggestions: [
      'Add historical ad tracking for competitor strategy change detection',
      'Build competitor messaging database for trend analysis over time',
      'Add automated alerts when new competitor enters market',
    ],
    ...
    fallback_behavior: 'Use cached competitive data if available. Suggest manual research via ads.google.com/transparency as fallback.',
    reference_docs: [],
    is_team_member: true,
    icon: '🔍',
    color: '#6366F1',
  ...
  },
  {
    slug: 'security-chief',
    name: 'Security Chief',
    description: 'Security audit agent. Reviews MCP tool outputs for prompt injection, data leakage, and suspicious patterns. Runs weekly via cron and on-demand.',
    category: 'meta',
    pack: 'seo_team',
    quality_tier: 'solid',
    quality_score: 74,
    quality_notes: 'Reasoning-only agent with zero external access - minimal attack surface. Good false positive framework distinguishes legitimate ad HTML from actual threats. Weekly cadence appropriate for current traffic.',
    strengths: [
      'Zero external tool access - cannot be exploited for data exfiltration',
      'False positive framework tuned for ad data (HTML in creatives is expected)',
      'Severity-based triage with clear escalation protocol',
      'Pattern detection across time for burst attack identification',
    ],
    weaknesses: [
      'Cannot block in real-time - only post-hoc review',
      'Depends on sanitizer doing the actual blocking',
      'No machine learning - pure pattern matching via reasoning',
    ],
    improvement_suggestions: [
      'Add anomaly scoring model trained on historical audit data',
      'Enable real-time alerting for CRITICAL findings',
      'Add dashboard widget for security health score',
    ],
