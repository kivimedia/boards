  ...
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px 0;">
      ...
      <div style="text-align: center; margin: 24px 0;">
        <a href="${siteUrl}" style="display: inline-block; background: #4F6BFF; color: #fff; text-decoration: none; padding: 10px 24px; border-radius: 8px; font-weight: 600; font-size: 13px;">View in Kivi Media</a>
      </div>

      <p style="color: #999; font-size: 11px; text-align: center;">
        Sent by Kivi Media weekly planner
      </p>
    </div>
  `;
}
